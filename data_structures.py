...
def main():
	...
	print "***** SETS *****"
	empty_set = set() # Sets are relatively new to Python and so you have to use the set constructor to create them. set() returns an empty set.
	...
	yet_another_set = another_set - my_set # You can use the set operators on Python sets! yetAnotherSet now contains 4 and 5 after performing set difference
