...
def main():
	...
	try:
		print y # y has not been defined; notice this was only caught once we ran this code
...
def printArg(arg):
	print arg # To print something, just write "print <thing you want to print>" (without the < >)
